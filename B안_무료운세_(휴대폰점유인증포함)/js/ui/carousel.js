...
define('ui/carousel', ['jquery', 'vcui'], function ($, core) {
    ...
    var slide_flag = false; //[20191203] 앱접근성 :  ios13.2.3에서 이중실행방지
    ...
    var Carousel = core.ui('Carousel', {
        ...
        buildArrows: function buildArrows() {
            ...
            if (opt.arrows === true) {
                ...
                if (self.slideCount > opt.slidesToShow) {
                    ...
                    self._updateArrow($p, true);
                    self._updateArrow($n, true);
        ...
        changeSlide: function changeSlide(event, dontAnimate) {
            ...
            if (!slide_flag) { //[20191203] 앱접근성 :  ios13.2.3에서 이중실행방지
                slide_flag = true; //[20191203] 앱접근성 :  ios13.2.3에서 이중실행방지
